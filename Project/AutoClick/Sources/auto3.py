...
Auto.Images_Action_Result=Auto.ReadInformationFromJson("../Log/houchi.json")
Auto.Images_Action_Result=Auto.Images_Action_ResultInit(Auto.Images_Action_Result)

# 画像認識動作設定
search_icon1_sequence = []
search_icon1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image00/*.png', 10, 0.99, True))
search_icon1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image01/*.png', 10, 0.97, True))

select_server1_sequence = []
select_server1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer01/*.png', 1.8, 0.8, True))
select_server1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer02/*.png', 1.8, 0.8, True))
select_server1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer03/*.png', 1.8, 0.8, True))
select_server1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer04/*.png', 1.8, 0.8, True))
select_server1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer05/*.png', 1.8, 0.8, True))
select_server1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer06/*.png', 1.8, 0.8, True))
select_server1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer07/*.png', 1.8, 0.8, True))
select_server1_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer08/*.png', 1.8, 0.8, True))


search_icon2_sequence = []
search_icon2_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image00/*.png', 10, 0.99, True))
search_icon2_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image01/*.png', 10, 0.97, True))
search_icon2_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image02/*.png', 10, 0.99, True))
search_icon2_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image03/*.png', 10, 0.99, True))
search_icon2_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image04/*.png', 10, 0.99, True))
search_icon2_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image05/*.png', 10, 0.99, True))
search_icon2_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 0, '../Images/image06/*.png', 10, 0.99, True))

select_server2_sequence = []
select_server2_sequence.append(Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.BREAK, 2, 5, '../Images/image_SelectServer09/*.png', 1.8, 0.8, True))


action_sequence_waiting = Auto.RecognitionInformation(Auto.ACTION.CLICK, Auto.RESULT.NG, Auto.END_ACTION.CONTINUE, 3, 20, '../Images/image_waiting/*.png', 4, 0.99, False)
...
action_sequence_start2 = Auto.RecognitionInformation(Auto.ACTION.CLICK, Auto.RESULT.OK, Auto.END_ACTION.CONTINUE, 1, 0, '../Images/image_start/*.png', 1.8, 0.93, True)
...
def chokyo(sequence, server_sequence, flag_timecheck):
    ...
    if Auto.Condition_Judge(Auto.RESULT.OK, result_file_click):
        ...
        result_start = Auto.Images_Action_ByInformation(action_sequence_start, x_offset_dictionary, y_offset_dictionary)  # "プロセス実行", result_waiting
        action_kyoudou1=Auto.RecognitionInformation(Auto.ACTION.CLICK ,Auto.RESULT.OK, Auto.END_ACTION.CONTINUE ,3, 2 ,'../Images/image_kyoudou1/*.png' , 0.8 , 0.93 , True)
        ...
        if Auto.Condition_Judge(Auto.RESULT.OK, result_action):
            action_kyoudou2=Auto.RecognitionInformation(Auto.ACTION.CLICK ,Auto.RESULT.NG, Auto.END_ACTION.FOLDER_END_BREAK, 5,2,'../Images/image_kyoudou2/*.png' , 0.3 , 0.93 , True)
...
def event2( flag_timecheck):
    if flag_timecheck and datetime.time(00,00,0) <= datetime.datetime.now().time() and  datetime.datetime.now().time() <= datetime.time(20,00,0):       
        action_sequence_event3 = Auto.RecognitionInformation(Auto.ACTION.CLICK, Auto.RESULT.OK, Auto.END_ACTION.CONTINUE, 6, 0, '../Images/image_event2/Click9*.png', 0.8, 0.93, True)
    ...
    if Auto.Condition_Judge(Auto.RESULT.OK, result_file_click):
        ...
        if Auto.Condition_Judge(Auto.RESULT.OK, result_server):
            ...
            if flag_login:
                ...
                action_sequence_main3 = Auto.RecognitionInformation(Auto.ACTION.CLICK, Auto.RESULT.NG, Auto.END_ACTION.CONTINUE, 3, 5, '../Images/image/Click07*.png', 0.2, 0.93, True)
            ...
            if flag_login or flag_execute:
                ...
                #result_action = Auto.Images_Action_ByInformation(action_kyoudou1,x_offset_dictionary,y_offset_dictionary)
                #if result_action:
                #    action_kyoudou2=Auto.RecognitionInformation(Auto.ACTION.CLICK ,Auto.RESULT.NG, Auto.END_ACTION.FOLDER_END_BREAK, 3,4,'../Images/image_kyoudou2/*.png' , 0.3 , 0.93 , True)
                #    result_action = Auto.Images_Action_ByInformation(action_kyoudou2,x_offset_dictionary,y_offset_dictionary)
                event2(flag_timecheck)
            highspeed()
            UnderWare()
...
def main():
    ...
    try:
        while 1:
            #Hospot起動
            action_hotspot = Auto.RecognitionInformation(Auto.ACTION.CLICK, Auto.RESULT.OK, Auto.END_ACTION.FOLDER_END_BREAK, 2, 2, '../Images/hotspot/*.png', 1.8, 0.95, True)
            ...
            #mementomori実行
            action_mementomori = Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.OK, Auto.END_ACTION.CONTINUE,1, 3, '../Images/mementomori/Click00*.png', 1.8, 0.95, True)
            result_action = Auto.Images_Action_ByInformation(action_mementomori,x_offset_dictionary,y_offset_dictionary)
            if Auto.Condition_Judge(Auto.RESULT.OK, result_action):
                action_mementomori = Auto.RecognitionInformation(Auto.ACTION.DOUBLE_CLICK, Auto.RESULT.NG, Auto.END_ACTION.CONTINUE,25, 100, '../Images/mementomori/Click05*.png', 5, 0.95, True)
                result_action = Auto.Images_Action_ByInformation(action_mementomori,x_offset_dictionary,y_offset_dictionary)
                
                action_mementomori = Auto.RecognitionInformation(Auto.ACTION.CLICK, Auto.RESULT.NG, Auto.END_ACTION.CONTINUE, 3, 5, '../Images/mementomori/Click1*.png', 1.8, 0.95, True)
                result_action = Auto.Images_Action_ByInformation(action_mementomori,x_offset_dictionary,y_offset_dictionary)
                Auto.WriteInformationToJson("../Log/mementomori.json")    
            #Sub searver周回
            flag_timecheck = False
            for sequence in search_icon1_sequence:
                for server_sequence in select_server1_sequence:
                    ...
                    Log.Write_MessageList(logfile_path, message_list)
                    message_list.clear()
                    Auto.WriteInformationToJson("../Log/houchi.json")    
            #Main searver周回
            flag_timecheck = True
            for sequence in search_icon2_sequence:
                for server_sequence in select_server2_sequence:
