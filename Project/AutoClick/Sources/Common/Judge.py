...
class Judge:
    ...
    def Result(self , condition_list = condition_list ,information = information,default_result=default_result):
        ...
        result = self.Results_ByDictionaryInformation(condition_list,information,default_result)
        return result


    def Results_ByDictionaryInformation(self , condition_list , information  , default_result = None):
        if condition_list is None:
            self.logger.log("Judge result condition is none","INFO")        
            return default_result
        elif condition_list == "":
            self.logger.log("Judge result condition is a blank ","INFO")        
            return default_result
        elif information is None:
            self.logger.log("Judge result information is none","INFO")        
            return default_result
        else:
            ...
            if type(condition_list) == list:
                if condition_list ==[]:
                    self.logger.log("Judge result condition is blank","INFO")
                    return default_result
                for condition in condition_list:
                    ...
                    if result == False:
                        ...
                        self.logger.log("Judge result false."+join_trace_list_or,"INFO")
                        return False
                    trace_list.append(join_trace_list_or)
            else:
                if condition_list == "":
                ...
                if result == False:
                    self.logger.log("Judge result false")
                    return False
            self.logger.log("Judge result true("+",".join(trace_list)+")","INFO")
            return True
    ...
    def TextChangeToData_ByDictionary(self , expression , data_dictionary, default_key = "",trace_list=[]):
        ...
        if type(temp_dictionary) == dict:
            if default_key != "":
                ...
                trace_list.append(expression+"(" + str(value) + ":by Default key)")
                return value
            else:
            ...
            trace_list.append(expression+"("+ temp_dictionary + ")")
